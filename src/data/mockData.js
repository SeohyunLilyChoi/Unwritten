...
export const MOCK_NEW_ANSWER = {
  headline: '거절할 수 있어요 — 단, 방식이 중요해요.',
  highlight: '단순 거절보다 업무 상황을 이유로 드는 방식이 훨씬 자연스럽게 통해요.',
  body: '콘텐츠 9건 · 커뮤니티 142건을 분석했어요.',
  dataSummary: '1~3년차 직장인의 63%가 입사 후 야근을 한 번이라도 거절한 경험이 있어요.',
  communitySummary: '미리 알리고 대안(예: 내일 오전에 마무리하겠다)을 제시하는 방식이 효과적이었다는 반응이 많아요.',
  dataCard: {
    title: '야근을 거절해본 적 있는 직장인 비율',
    matrix: {
  ...
  communityPosts: [
    { id: 101, title: '처음으로 야근 거절해봤어요', preview: '개인 약속이 있다고 미리 말씀드렸더니 팀장님이 ok 하셨어요. 미리 알리는 게 핵심인 것 같아요.', role: '마케팅 · 2년차', comments: 18, likes: 41 },
    { id: 102, title: '야근 거절이 진짜 가능한가요?', preview: '팀마다 다르지만, 일정을 미리 공유하고 업무 진행 상황을 보여주면 훨씬 수월하더라고요.', role: '개발 · 4년차', comments: 27, likes: 55 },
  ],
}
